...
<body>
    <div class="container">
        ...
        <div class="content">
            <span class="badge">Seguridad &amp; Acceso</span>

            <div class="greeting">¡Hola, {{ $user->name }}!</div>

            <div class="text">
                Recibimos una solicitud para restablecer la contraseña de acceso a tu cuenta en el <strong>Panel Administrativo Dygytel</strong>.
            </div>

            <div class="text">
                Para definir una nueva contraseña de acceso segura, haz clic en el siguiente botón:
            </div>
            ...
            <div class="security-box">
                ...
                Este enlace de restablecimiento es de un solo uso y expirará en <strong>{{ $expireHours ?? 2 }} horas</strong>. Si tú no solicitaste este cambio, puedes ignorar este correo; tu cuenta permanece completamente protegida.
            </div>
